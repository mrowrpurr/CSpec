function(expect actual)
    ...
    cmake_language(CALL "__cspec_assert_${assertion}" "${positive_assertion}" "${actual}" ${ARGN})
endfunction()
...
macro(expect_fail message)
    if("${CMAKE_CURRENT_FUNCTION}" MATCHES ^__cspec_assert_)
        ...
        message(SEND_ERROR "${assertion_name} failed: ${message}")
    else()
